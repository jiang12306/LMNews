...
- (void)viewDidLoad {
    ...
    NSString* tempStr = [NSString stringWithFormat:@"%@?ver=%@", @"http://qiwen.tkmob.com/apk/about.htm", versionStr];
    NSString* encodeStr = [tempStr stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
    ...
    self.progressView = [[UIProgressView alloc]initWithFrame:CGRectMake(0, self.webView.frame.origin.y, self.view.frame.size.width, 10)];
    self.progressView.tintColor = [UIColor colorWithHex:themeOrangeString];
