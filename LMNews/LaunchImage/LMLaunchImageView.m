                ...
                if (arr != nil && arr.count > 0) {
                    ...
                    if (shouldLoadData) {
                        ...
                        if (position == 1) {//右上角
                            ...
                            self.overBtn.center = CGPointMake(screenRect.size.width/2, screenRect.size.height - 44);
                        }else if (position == 3) {//右下角
                            self.overBtn.frame = CGRectMake(screenRect.size.width - 10 - 75, screenRect.size.height - 64, 75, 30);
                        }
                        
                        NSString* picStr = [self.currentCover.pic  stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
...
-(void)loadLaunchImageData {
    ...
    [tool postWithCmd:27 ReqData:nil successBlock:^(NSData *successData) {
        @try {
                ...
                if (err == ErrCodeErrNone) {
                    ...
                    if (arr != nil && arr.count > 0) {
                        ...
                        if (position == 1) {//右上角
                            ...
                            weakSelf.overBtn.frame = CGRectMake(screenRect.size.width - 10 - 75, screenRect.size.height - 64, 75, 30);
                        }
                        
                        NSString* picStr = [weakSelf.currentCover.pic  stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
